...
function imageop(n){
   for(i=0;i<9;i++){   mainimg[i].style.display="none";}

       for(i=0;i<9;i++){    subimg[i].style.border="1px solid #ffffff";}
...
function pmenu(n){
        for(i=0;i<8;i++){  listm1[i].style.backgroundColor="#ffffff";
...
function popen(n){
     for(i=0;i<4;i++){     lmt[i].style.display="none";
}
...
function pclose(n){
    ...
    lmtd[n].style.display="none";
         ...
         for(i=0;i<4;i++){    lmt[i].style.display="block";
}
