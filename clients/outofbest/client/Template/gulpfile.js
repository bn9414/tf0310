 ...
 */
var config = {
	name:   'Qusq Theme Plugins',
	banner: ['/*!',
		' * Qusq Theme Plugins v<%= pkg.version %>',
		' * <%= pkg.description %>',
...
gulp.task('copy:fonts', function() {
	gulp.src([ src_dir + 'font/**/*']).pipe(gulp.dest( dist_dir + 'font/'));
});
 ...
 * Default Task
 */
gulp.task( 'default', gulpsync.sync( ['compile:js', 'compile:scss', 'compile:vendor_css', 'copy:all', 'watch' ] ) );
