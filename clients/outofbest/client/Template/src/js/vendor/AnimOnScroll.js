...
;( function( window ) {
	...
	function AnimOnScroll( options ) {
		...
		this.el = $( this.options.container_selector )[0];
		this._init();
	}
	...
	AnimOnScroll.prototype = {
				...
				this.items.forEach( function( el, i ) {
					...
					var oddEvenItemAnimate = function( oddEvenValue ){
						...
						if ((oddEvenValue !== i % 2) && me.attr('data-initial-top')) {
							...
							me.attr('data-initial-top', ( $.isNumeric(parseInt(me.css('margin-top'), 10)) ) ? parseInt(me.css('margin-top'), 10) : 0);
		...
		_remove : function(){
			...
			$(this.options.container_selector + ' ' + this.options.items_selector).removeAttr('style');
		}
	}
