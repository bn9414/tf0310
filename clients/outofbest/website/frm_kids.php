...
if ($conn->query($sql) === TRUE) {
    echo "Table kids created successfully";
} else {
...
$sql1 = "INSERT INTO kids (tit, des, rate, url, logo)
VALUES (' ', ' ', ' ','','')";  
...
$sql = "UPDATE kids SET tit='$tit1',des='$des1',url='$url1',rate='$rate1',logo='$logo1' WHERE id=1";
...
if ($conn->query($sql) === TRUE) {
    ...
    $sql2 = "UPDATE kids SET tit='$tit2',des='$des2',url='$url2',rate='$rate2',logo='$logo2' WHERE id=2";
...
if ($conn->query($sql2) === TRUE) {
    ...
    $sql3 = "UPDATE kids SET tit='$tit3',des='$des3',url='$url3',rate='$rate3',logo='$logo3' WHERE id=3";
...
if ($conn->query($sql3) === TRUE) {
    ...
    $sql4 = "UPDATE kids SET tit='$tit4',des='$des4',url='$url4',rate='$rate4',logo='$logo4' WHERE id=4";
...
if ($conn->query($sql4) === TRUE) {
    ...
    $sql5 = "UPDATE kids SET tit='$tit5',des='$des5',url='$url5',rate='$rate5',logo='$logo5' WHERE id=5";
...
if ($conn->query($sql5) === TRUE) {
    ...
    $sql6 = "UPDATE kids SET tit='$tit6',des='$des6',url='$url6',rate='$rate6',logo='$logo6' WHERE id=6";
...
if ($conn->query($sql6) === TRUE) {
    ...
    $sql7 = "UPDATE kids SET tit='$tit7',des='$des7',url='$url7',rate='$rate7',logo='$logo7' WHERE id=7";
...
if ($conn->query($sql7) === TRUE) {
    ...
    $sql8 = "UPDATE kids SET tit='$tit8',des='$des8',url='$url8',rate='$rate8',logo='$logo8' WHERE id=8";
...
if ($conn->query($sql8) === TRUE) {
    ...
    $sql9 = "UPDATE kids SET tit='$tit9',des='$des9',url='$url9',rate='$rate9',logo='$logo9' WHERE id=9";
...
if ($conn->query($sql9) === TRUE) {
    ...
    $sql10 = "UPDATE kids SET tit='$tit10',des='$des10',url='$url10',rate='$rate10',logo='$logo10' WHERE id=10";
