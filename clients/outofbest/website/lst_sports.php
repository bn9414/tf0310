			...
			<div class="ish-container-inner">
				<div class="ish-row">
					...
					<div class="site-branding">
						...
						<h2 class="site-subtitle"> <span>Sports</span> websites <span>!</span></h2>
 ...
 */
  ...
  $sql = "SELECT  id, tit, des, url, rate,logo FROM sports WHERE id=1";
$result = $conn->query($sql);
...
if ($result->num_rows > 0) {
    ...
    while($row1 = $result->fetch_assoc()) {
        $rowz1 =$row1;
          ...
          $sql2 = "SELECT  id, tit, des, url, rate,logo FROM sports WHERE id=2";
...
if ($result->num_rows > 0) {
    ...
    while($row2 = $result->fetch_assoc()) {
        ...
        $sql3 = "SELECT  id, tit, des, url, rate,logo FROM sports WHERE id=3";
...
if ($result->num_rows > 0) {
    ...
    while($row3 = $result->fetch_assoc()) {
        ...
        $sql4 = "SELECT  id, tit, des, url, rate,logo FROM sports WHERE id=4";
...
if ($result->num_rows > 0) {
    ...
    while($row4 = $result->fetch_assoc()) {
        ...
        $sql5 = "SELECT  id, tit, des, url, rate,logo FROM sports WHERE id=5";
...
if ($result->num_rows > 0) {
    ...
    while($row5 = $result->fetch_assoc()) {
        ...
        $sql6 = "SELECT  id, tit, des, url, rate,logo FROM sports WHERE id=6";
...
if ($result->num_rows > 0) {
    ...
    while($row6 = $result->fetch_assoc()) {
        ...
        $sql7 = "SELECT  id, tit, des, url, rate,logo FROM sports WHERE id=7";
...
if ($result->num_rows > 0) {
    ...
    while($row7 = $result->fetch_assoc()) {
        ...
        $sql8 = "SELECT  id, tit, des, url, rate,logo FROM sports WHERE id=8";
...
if ($result->num_rows > 0) {
    ...
    while($row8 = $result->fetch_assoc()) {
        ...
        $sql9 = "SELECT  id, tit, des, url, rate,logo FROM sports WHERE id=9";
...
if ($result->num_rows > 0) {
    ...
    while($row9 = $result->fetch_assoc()) {
        $rowz9 =$row9;
                ...
                $sql10 = "SELECT  id, tit, des, url, rate,logo FROM sports WHERE id=10";
