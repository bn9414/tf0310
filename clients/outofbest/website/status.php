      ...
      method="POST"   novalidate="novalidate" > 
                   ...
                   <!-- <div class="frm hfrm" style="visibility: hidden">
                    ...
                    <div class="frm frmfrm">
                        <label for="file">Upload images whom to you dedicated</label><br>
                    ...
                    <div class="padp" style=""><p><sup style="color:#9b3236;">*</sup>The Quotes should be submitted before 48-72 hours. 10 quotes will be chosen in random.</p></div>
                </form>
            </div>
        </div>
            <div class="cnt-img">
